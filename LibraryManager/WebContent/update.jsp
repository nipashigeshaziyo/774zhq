		...
		<div class="content">
			...
			<div class="show">
				...
				<form class="block" action="<%=request.getContextPath()%>/Update" method="post">
					书名：<input class="ip" type="text" name="name" value="<%=book.getName() %>"/><br/>
					...
					作者：<input class="ip" type="text" name="author" value="<%=book.getAuthor() %>"/><br/>
					...
					价格：<input class="ip" type="text" name="price" value="<%=book.getPrice() %>"><br/>
					数量：<input class="ip" type="text" name="count" value="<%=book.getCount() %>"><br/>
					简介：<textarea cols="30" rows="3" name="introduce"><%=book.getIntroduce() %></textarea><br/>
